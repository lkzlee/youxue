...
{
	Log log = LogFactory.getLog(CustomActionEnter.class);
	...
	public CustomActionEnter(HttpServletRequest request, String rootPath)
	{
		...
		{
			log.info(this.rootPath + request.getRequestURI().substring(contextPath.length()));
		}
		else
		{
			log.info(this.rootPath + request.getRequestURI());
		}
		//		log.info("configManager:" + configManager.getAllConfig());
	}
